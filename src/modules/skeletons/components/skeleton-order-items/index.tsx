      ...
      <div className="grid grid-cols-[122px_1fr] gap-x-4">
        ...
        <div className="block xsmall:flex xsmall:items-start xsmall:justify-between">
          <div className="flex flex-col gap-y-2">
            <div className="w-24 xsmall:w-48 h-6 bg-gray-100"></div>
            <div className="w-24 h-4 bg-gray-100"></div>
            <div className="w-24 xsmall:w-32 h-4 bg-gray-100"></div>
          </div>
          <div className="w-24 xsmall:w-32 h-6 bg-gray-100"></div>
        </div>
      </div>
