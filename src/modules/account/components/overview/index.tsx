    ...
    <div>
      <div className="small:hidden">
        ...
        <div className="text-base-regular">
          <ul>
            <li>
              <Link href="/account/profile" className="flex items-center justify-between py-4 border-b border-gray-200 px-8" legacyBehavior>
                <>
            ...
            <li>
              <Link href="/account/addresses" className="flex items-center justify-between py-4 border-b border-gray-200 px-8" legacyBehavior>
                <>
                  <div className="flex items-center gap-x-2">
                    <MapPin size={16} />
            ...
            <li>
              <Link href="/account/orders" className="flex items-center justify-between py-4 border-b border-gray-200 px-8" legacyBehavior>
                <>
                  <div className="flex items-center gap-x-2">
                    <Package size={16} />
                    <span>{ t('Orders') }</span>
